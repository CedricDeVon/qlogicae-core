...
namespace QLogicaeCore
{
    ...
    public:
        ...
        std::string CONFIGURATIONS_ENVIRONMENT_LOG_FILE_COLLECTIVIZATION_FILE_NAME;
        ...
        std::string CONFIGURATIONS_ENVIRONMENT_LOG_FILE_COLLECTIVIZATION_OUTPUT_FOLDER_PATH;
